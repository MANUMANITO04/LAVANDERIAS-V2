...
def build_global_feasible_route(data, nodes, depot, tolerancia_seg=300):
    """
    Heurística GreedyTW con tolerancia: construye una ruta completa válida.
    """
    visited = set()
    current = depot
    ...
    while len(visited) < len(nodes):
        ...
        if not heap:
            print("⚠️ No se puede construir una ruta global válida.")
            return None, None
